...
We filed [pwnkit#116](https://github.com/PwnKit-Labs/pwnkit/issues/116) to disable EGATS in default aliases. The code remains available but opt-in. A separate postmortem is planned to document where the implementation diverges from MAPTA-style scoring.
...
- The follow-on routing work is tracked in [Dynamic Routing Design](/research/dynamic-routing-design/) and [pwnkit#113](https://github.com/PwnKit-Labs/pwnkit/issues/113).
