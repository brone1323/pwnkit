...
const INSTALL_URL = "https://raw.githubusercontent.com/PwnKit-Labs/pwnkit/main/install.sh";
const RELEASES_URL = "https://github.com/PwnKit-Labs/pwnkit/releases/latest";
